...
class TwitterSearchPageSearchState
    with ChangeNotifier, DiagnosticableTreeMixin {
  String _searchBarText = ""; //? bunları late veremiyor muyum ?
  TwitterSearchPageSearchScreenBodyState _searchScreenBodyState =
      TwitterSearchPageSearchScreenBodyState.searchSomethingState;

  String get searchBarText => _searchBarText;
  TwitterSearchPageSearchScreenBodyState get searchScreenBodyState =>
      _searchScreenBodyState;

  String get searchForText =>
      '${LocalizationService.of().getLocale.twitterSearchPageSearchScreenSearchForText}:"$_searchBarText"';
  String get goToText =>
      LocalizationService.of().getLocale.twitterSearchPageSearchScreenGoToText +
      _searchBarText;

  List<UserModel> get filteredUserListBySearchBarText =>
      users.searchTweetsTextForKeyword(_searchBarText);
